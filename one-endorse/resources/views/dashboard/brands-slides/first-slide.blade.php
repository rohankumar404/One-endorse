...
<div class="slide-card bg-white rounded-adv p-3">
    <!-- Header Section -->
    ...
    <div class="top-right-corner">
        <img src="{{ asset('assets/img/icon/elements/shape.png') }}" alt="corner-bg">
        <div class="top-circle border-1 p-2 rounded-circle d-flex justify-content-center align-items-center">
