    ...
    <div class="blog-card bg-white box-shadow-16 rounded-adv p-12">
        ...
        <div class="card-content pt-3">
            <div class="time-info d-flex align-items-center mb-2">
                ...
                <span class="font-12 text-normal">{{ $globaltrendblog['read_time'] }} min read</span>
            </div>
            <h5 class="card-title font-20 text-700">{{ $globaltrendblog['title'] }}</h5>
            <p class="font-14 text-normal my-3">{{ $globaltrendblog['excerpt'] }}</p>
